...
(Switch-ADJUSTMODE settings entry, hidden except while ADJUSTMODE is On so
the Off path stays reachable, plus the 90266 "On" refuse) and hudadmin
(90267 ADJUSTMODE confirm refuse).
